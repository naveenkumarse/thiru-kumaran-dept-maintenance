...
const OrderNumberList = ({loan}) => {
    ...
    return (
        <tr>
            ...
            <td class="p-2 whitespace-nowrap">
                <div class="text-left">{loan.orderNo}</div>
            </td>
            <td class="p-2 whitespace-nowrap">
            ...
            <td class="p-2 whitespace-nowrap">
                <div class="text-left"><input type="number" className="border border-slate-300 rounded-md px-4" min={0} value={amount} onChange={(e) => setAmount(e.target.value)} /></div>
            </td>
            <td class="p-2 whitespace-nowrap">
                <div class="text-center">     <button class="inline-flex items-center px-4 py-2 bg-gray-200 hover:bg-green-300 text-gray-800 text-sm font-medium rounded-md" onClick={(e)=> handleEnter(e)}>
