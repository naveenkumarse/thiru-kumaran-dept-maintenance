    ...
    return (
        <>
            <tr>
                ...
                <td class="p-2 whitespace-nowrap">
                    <div class="text-left">{closedParty.address}</div>
                </td>
                <td class="p-2 whitespace-nowrap">
                    <div class="text-left">{closedParty.loanAmount}</div>
                </td>
                <td class="p-2 whitespace-nowrap">
                    <div class="text-left"><button onClick={(e) => handleAddLoan(e)} class="group relative h-8 w-24 overflow-hidden rounded-lg bg-white text-lg shadow">
