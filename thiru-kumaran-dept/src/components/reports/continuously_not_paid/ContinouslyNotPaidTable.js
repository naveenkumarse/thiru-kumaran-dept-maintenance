                    ...
                    <div class="w-full pt-5 mx-auto bg-white shadow-lg rounded-sm border border-gray-200 ">
                        ...
                        <div className="flex lg:justify-between">
                            ...
                            <form class="mt-6 w-full" onSubmit={(e)=> handleSubmit(e)}>
                                ...
                                <input id="id" type="number" min={1} max={100000} name="id" placeholder="Enter the Number of days" autocomplete="id" class="block w-1/2 p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" value={number} onChange={(e) => setNumber(e.target.value)} required />
